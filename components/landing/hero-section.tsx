                ...
                <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    ...
                    <div className="text-left text-gray-900">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-8">
                            <Link href="/sign-up" aria-label="Start Free Trial" onClick={() => posthog?.capture('cta_clicked', { location: 'hero', label: 'Start Free Trial' })}>
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    posthog?.capture('demo_opened', { location: 'hero' });
                                }}
                    ...
                    <div className="flex flex-col items-center gap-0 w-full max-w-lg mx-auto lg:max-w-none" aria-hidden="true">
                                        ...
                                        {demoState >= 2 && (
                                            ...
                                            >
                                                <div className="flex items-center gap-2 mb-3">
                                                    <div className="w-6 h-6 rounded-full bg-[#C44828] text-white flex items-center justify-center text-[10px] font-bold">
                                                        GW
                                                    </div>
                                                    <div className="text-xs font-semibold text-gray-600">Ghostwriting your draft...</div>
                                                </div>
